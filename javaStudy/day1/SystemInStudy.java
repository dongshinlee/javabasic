...
/*
 * 입력(input) 개념 알아보기
 * 일반출력 이라는 개념은 데이터가 프로그램에서 콘솔로 나가는 것을 말하고 이를 전문용오로 Standard Output 이라고 함
...
public class SystemInStudy {
	...
	public static void main(String[] args) throws IOException {
		...
		// 이 API를 이용하면, 콘솔에 입력한 키보드 첫번째 하나의 값만 int 로 리턴시킴
		int input1 = System.in.read() - 48; 
		...
		System.out.printf("입력된 숫자: %d ", input1);
